                ...
                <div class="p-6 ">
                    <form method="POST" action="{{ route('karyawan.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="radio" id="cuti" name="status" value="Cuti" class="form-radio h-3 w-3 mx-1">
                            <x-input-label for="cuti" class="inline font-normal">Cuti</x-input-label><br>
                            <input type="radio" id="bekerja" name="status" value="Bekerja" class="form-radio h-3 w-3 mx-1">
                            <x-input-label class="inline font-normal" for="bekerja">Bekerja</x-input-label><br>
                            <input type="radio" id="mengundurkan_diri" name="status" value="Mengundurkan Diri" class="form-radio h-3 w-3 mx-1">
