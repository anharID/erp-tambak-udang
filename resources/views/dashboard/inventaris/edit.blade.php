                ...
                <div class="p-6 ">
                    <form method="POST" action="{{ route('inventaris.update', $inventari->id) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_barang" class="block mt-1 w-full" type="text" name="nama_barang" :value="$inventari->nama_barang ?? old('nama_barang')" required autofocus autocomplete="nama_barang" />
                        ...
                        <div class="mt-4">
                            ...
                            <select name="jenis_barang" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm px-4 py-2">
                                ...
                                @foreach($availableJenisBarang as $jenisBarang)
                                    <option value="{{ $jenisBarang->jenisbarang }}" {{ $inventari->jenis_barang == $jenisBarang->jenisbarang ? 'selected' : '' }}>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="tanggal" class="block mt-1 w-full" type="date" name="tanggal_peroleh" :value="$inventari->tanggal_peroleh ?? old('tanggal_peroleh')" required autofocus autocomplete="tanggal_peroleh" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="stok" class="block mt-1 w-full" type="number" name="stok" :value="$inventari->stok ?? old('stok')" required autocomplete="stok" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="catatan" class="block mt-1 w-full" type="text" name="catatan" min="0" :value="$inventari->catatan ?? old('catatan')" autocomplete="catatan" />
