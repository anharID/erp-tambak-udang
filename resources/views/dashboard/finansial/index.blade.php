                        ...
                        <table class="w-full table-auto mt-4 datatable hover display nowrap">
                            <thead class="bg-gray-50 dark:bg-gray-800">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Jenis Transaksi</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap flex">
                                        <a href="{{ route('finansial.edit', $row->id) }}" class="text-yellow-600 mr-4"><x-tabler-edit class="w-6 h-6" /></a>
