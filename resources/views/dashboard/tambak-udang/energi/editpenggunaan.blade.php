<x-admin>
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 text-gray-900 dark:text-gray-100">
            <h1 class="mb-4 text-xl font-bold">Ubah Kategori Penggunaan</h1>
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                <div class="p-6 ">
                    <form method="POST" action="{{ route('penggunaan.update', ['penggunaanId'=>$penggunaan->id]) }}">
                        @csrf
                        @method('put')
                        <div>
                            <div>
                                ...
                                <x-text-input id="penggunaan" class="block mt-1 w-full" type="text" name="penggunaan"
                                    :value="$penggunaan->penggunaan ?? old('penggunaan')" autofocus
                                    autocomplete="penggunaan" />
