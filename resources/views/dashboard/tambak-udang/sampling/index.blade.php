                ...
                <div class="mt-3 mb-2 overflow-auto h-full">
                    ...
                    <table class="table-fixed w-full border border-gray-200 mb-14">
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="p-2 w-1/4 font-medium ">Kolam</td>
                                <td class="p-2 " x-text={{ 'selectedData.kolam.nama' }}></td>
                            </tr>
                            <tr>
                                <td class="p-2 w-1/4 font-medium ">Tanggal</td>
                                <td class="p-2 " x-text={{ 'selectedData.tanggal' }}></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Umur</td>
                                <td class="p-2 " x-text="selectedData.umur"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">ABW</td>
                                <td class="p-2 " x-text="selectedData.abw + 'g'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">ADG</td>
                                <td class="p-2 " x-text="selectedData.adg + ' g/hari'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Size</td>
                                <td class="p-2 " x-text="selectedData.size + ' ekor/kg'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">FR</td>
                                <td class="p-2 " x-text="selectedData.fr + ' %'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">SR</td>
                                <td class="p-2 " x-text="selectedData.sr + ' %'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Biomassa</td>
                                <td class="p-2 " x-text="selectedData.biomas + ' kg'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">FCR</td>
                                <td class="p-2 " x-text="selectedData.fcr"></td>
                            </tr>
                            <tr>
