                ...
                <div class="mt-3 mb-2 overflow-auto h-full">
                    ...
                    <table class="table-fixed w-full border border-gray-200 mb-14">
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="p-2 font-medium ">Waktu Pemberian</td>
                                <td class="p-2 " x-text="selectedData.waktu_pemberian"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Jenis Pakan</td>
                                <td class="p-2 " x-text="selectedData.no_pakan"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Jumlah</td>
                                <td class="p-2 " x-text="selectedData.jumlah_kg"></td>
                            </tr>
                            <tr>
