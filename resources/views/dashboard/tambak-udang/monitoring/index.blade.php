                    ...
                    <!-- Modal description -->
                        <table class="table-fixed w-full border border-gray-200 mb-14">
                            <tbody class="divide-y divide-gray-200">
                                <tr>
                                    <td class="p-2 w-1/4 font-medium ">Siklus</td>
                                    <td class="p-2 " x-text={{ 'selectedData.siklus.tanggal_mulai' }}></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Kolam</td>
                                    <td class="p-2 " x-text="selectedData.kolam.nama"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Tanggal</td>
                                    <td class="p-2 " x-text="selectedData.tanggal"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Waktu Pengukuran</td>
                                    <td class="p-2 " x-text="selectedData.waktu_pengukuran"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Suhu</td>
                                    <td class="p-2 " x-text="selectedData.suhu + ' &deg;C'"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">pH</th>
                                    <td class="p-2 " x-text="selectedData.ph"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">DO</td>
                                    <td class="p-2 " x-text="selectedData.do + ' mg/L'"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Salinitas</td>
                                    <td class="p-2 " x-text="selectedData.salinitas + ' ppt'"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Kecerahan</td>
                                    <td class="p-2 " x-text="selectedData.kecerahan + ' cm'"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Warna Air</td>
                                    <td class="p-2 " x-text="selectedData.warna_air"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Tinggi Air</td>
                                    <td class="p-2 " x-text="selectedData.tinggi_air + ' cm'"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Cuaca</td>
                                    <td class="p-2 " x-text="selectedData.cuaca"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Amonia</td>
                                    <td class="p-2 " x-text="selectedData.amonia + ' ppm'"></td>
                                </tr>
                                <tr>
                                    <td class="p-2 font-medium ">Nitrit</td>
                                    <td class="p-2 " x-text="selectedData.nitrit + ' ppm'"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="p-2 break-words" x-text="selectedData.catatan"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
