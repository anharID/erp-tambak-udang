                ...
                <div class="p-6 ">
                    <form method="POST" action="{{ route('kolam.update', $kolam->id) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="$kolam->nama ?? old('nama')" required autofocus autocomplete="nama" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="lokasi" class="block mt-1 w-full" type="text" name="lokasi" :value="$kolam->lokasi ?? old('lokasi')" required autocomplete="lokasi" />
                        ...
                        <div class="mt-4">
                            ...
                            <select name="tipe" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm px-4 py-2">
                                ...
                                <option value="Kolam Riset" {{ $kolam->tipe == 'Kolam Riset' ? 'selected' : '' }}>Kolam Riset</option>
                                <option value="Kolam Bisnis" {{ $kolam->tipe == 'Kolam Bisnis' ? 'selected' : '' }}>Kolam Bisnis</option>
                            </select>
                        ...
                        <div class="mt-4 grid md:grid-cols-2">
                            <div class="mt-4 md:mt-2 md:mr-2">
                                ...
                                <x-text-input id="luas" class="block mt-1 w-full" type="number" name="luas" :value="$kolam->luas ?? old('luas')" required autocomplete="luas" />
                            ...
                            <div class="mt-4 md:mt-2 md:ml-2">
                                ...
                                <x-text-input id="kedalaman" class="block mt-1 w-full" type="number" step='0.1' name="kedalaman" :value="$kolam->kedalaman ?? old('kedalaman')" required autocomplete="kedalaman" />
