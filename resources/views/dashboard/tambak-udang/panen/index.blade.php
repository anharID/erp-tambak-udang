                ...
                <div class="mt-3 mb-2 overflow-auto h-full">
                    ...
                    <table class="table-fixed w-full border border-gray-200 mb-14">
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="p-2 font-medium ">Waktu Panen</td>
                                <td class="p-2 " x-text="selectedData.waktu_panen"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Tonase Besar</td>
                                <td class="p-2 " x-text="selectedData.tonase_besar + ' kg'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Tonase Kecil</td>
                                <td class="p-2 " x-text="selectedData.tonase_kecil + ' kg'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Tonase Jumlah</td>
                                <td class="p-2 " x-text="selectedData.tonase_jumlah + ' kg'"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Size Besar</td>
                                <td class="p-2 " x-text="selectedData.size_besar"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Size Kecil</td>
                                <td class="p-2 " x-text="selectedData.size_kecil"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Populasi</td>
                                <td class="p-2 " x-text="selectedData.populasi_terambil"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">ABW</td>
                                <td class="p-2 " x-text="selectedData.abw"></td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium ">Status</td>
                                <td class="p-2 " x-text="selectedData.status"></td>
                            </tr>
                            <tr>
