                    ...
                    <form method="POST"
                        ...
                        <div class="grid gap-4 mb-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal" class="block mt-1 w-full" type="date" name="tanggal"
                                    :value="$panen->tanggal ?? old('tanggal')" required autofocus autocomplete="tanggal" />
                            ...
                            <div>
                                ...
                                <x-text-input id="waktu_panen" class="block mt-1 w-full" type="time"
                                    name="waktu_panen" :value="$panen->waktu_panen ?? old('waktu_panen')" required autofocus
                        ...
                        <div class="grid gap-4 mb-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <x-text-input id="tonase_besar" class="block mt-1 w-full" type="number" step='0.01' min='0'
                                    name="tonase_besar" :value="$panen->tonase_besar ?? old('tonase_besar')" required autofocus
                            ...
                            <div>
                                ...
                                <x-text-input id="tonase_kecil" class="block mt-1 w-full" type="number" step='0.01' min='0'
                                    name="tonase_kecil" :value="$panen->tonase_kecil ?? old('tonase_kecil')" required autofocus
                        ...
                        <div class="grid gap-4 mb-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <x-text-input id="size_besar" class="block mt-1 w-full" type="number" step='0.01' min='0'
                                    name="size_besar" :value="$panen->size_besar ?? old('size_besar')" required autofocus
                            ...
                            <div>
                                ...
                                <x-text-input id="size_kecil" class="block mt-1 w-full" type="number" step='0.01' min='0'
                                    name="size_kecil" :value="$panen->size_kecil ?? old('size_kecil')" required autofocus
                        ...
                        <div>
                            ...
                            <x-text-input id="status" class="block mt-1 w-full" type="text" name="status"
                                :value="$panen->status ?? old('status')" autofocus autocomplete="status" />
