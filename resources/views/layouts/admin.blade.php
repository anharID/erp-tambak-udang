<!DOCTYPE html>
<html :class="{ 'dark': dark }" x-data="{ dark: localStorage.getItem('dark') === 'true' || false,   isSideMenuOpen: false, isProfileMenuOpen: false}" x-init="$watch('dark', value => localStorage.setItem('dark', value))" lang="{{ str_replace('_', '-', 
app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
            ...
            <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <!-- Theme toggler -->
                        <li class="flex">
                            <button class="rounded-md focus:outline-none focus:shadow-outline-purple" @click="dark = !dark" aria-label="Toggle color mode">
                                <template x-if="!dark">
                        ...
                        <!-- Profile menu -->
                        <li class="relative">
                            <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none" @click="isProfileMenuOpen = !isProfileMenuOpen" @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
