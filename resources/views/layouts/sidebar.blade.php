              ...
              <div class="py-4 text-gray-500 dark:text-gray-400">
                  ...
                  <ul>
                      ...
                      <li class="relative px-6 py-3">
                          ...
                          <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                          @endif
                          <a class="{{ request()->routeIs('inventaris.index') ? 'text-gray-800 dark:text-gray-100' : '' }} inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{ route('inventaris.index') }}">
                    ...
                    <li class="relative px-6 py-3">
                        @if (request()->routeIs('logistik.index'))
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                        @endif
                        <a class="{{ request()->routeIs('logistik.index') ? 'text-gray-800 dark:text-gray-100' : '' }} inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{ route('logistik.index') }}">
                            <span class="ml-4">Manajemen Logistik</span>
                        </a>
                    </li>
                      </a>
                  </li>
